...
const Footer = () => {
  return (
    <footer className={`flex justify-center flex-col md:flex-row my-5 mx-auto lg:mx-40 font-bold items-center space-x-5 v-screen`}>
      {/* Contact information */}
      <div className={`flex-1 items-center`}>
      {/* ${styles.costume_text} */}
        <h1 className={`text-center text-lg md:text-xl lg:text-3xl text-[#1E90FF] mb-3`}> <i>Đặt lịch ngay với chúng tôi</i> </h1>
        {/*Link Mail*/}
        <p> 
          <a 
            ...
            <img className={`mr-5 w-5 h-5 md:w-8 md:h-8`} src="/icon_mail.png" alt="Mail icon"/>
        ...
        <p> 
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"> 
            <img className={`mr-5 w-5 h-5 md:w-8 md:h-8`} src="/icon_fb.png" alt="Mail icon"/>
        ...
        <p> 
          <a
            ...
            target="_blank"
            rel="noopener noreferrer">
            <img className={`mr-5 w-5 h-5 md:w-8 md:h-8`} src="/icon_phone.png" alt="Mail icon"/>
            0942 190022
          </a>
        </p>
        {/*Link gg map*/}
        <p> 
          <a    
            ...
            target="_blank"
            rel="noopener noreferrer"> 
            <img className={`mr-5 w-5 h-5 md:w-8 md:h-8`} src="/icon_map.png" alt="Mail icon"/>
